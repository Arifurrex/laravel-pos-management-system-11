            ...
            <div class="flex flex-wrap items-center">
                ...
                <div
                    ...
                    <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                        ...
                        <form action="{{route('authentication.update',$user->id)}}" method="post">
                            @csrf
                            <div class="mb-4">
                                <label
                                    class="mb-2.5 block font-medium text-black dark:text-white">User Name</label>
                                <div class="relative">
                                    <input
                                        type="text"
                            ...
                            <div class="mb-4">
                                ...
                                <div
                                    ...
                                    <select
                                        ...
                                        <option value="1" class="text-body">Admin</option>
                                        <option value="2" class="text-body">Cashier</option>
                                    </select>
                                </div>
                                @error('is_admin')
                                <div>
