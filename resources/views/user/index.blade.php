        ...
        <div
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-primary">All users</li>
                </ol>
            </nav>
        </div>
        <!-- Breadcrumb End -->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                <p class="text-black dark:text-white">{{\Carbon\Carbon::parse($user->created_at)->diffForHumans()}}</p>
                            </td>
                            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                <p
                            ...
                            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                <div class="flex items-center space-x-3.5">
                                    ...
                                    <a class="hover:text-primary" href="{{route('authentication.edit',$user->id)}}">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="16"
                                            height="16"
                                    ...
                                    <a href="{{route('authentication.delete',$user->id)}}"  class="hover:text-danger" onclick="return confirm('are you sure delete it !')">
                                        <svg
                                            class="fill-current"
                                            width="18"
                                            height="18"
