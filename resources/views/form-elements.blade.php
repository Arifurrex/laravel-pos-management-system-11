                                    ...
                                    <div x-data="{ switcherToggle: false }">
                                        <label
                                            ...
                                            <div class="relative">
                                                ...
                                                <div
                                                    class="block h-8 w-14 rounded-full bg-meta-9 dark:bg-[#5A616B]"></div>
                                                <div
                                        ...
                                        <label
                                            ...
                                            <div class="relative">
                                                <input
                                                    ...
                                                    @change="switcherToggle = !switcherToggle" />
                                                <div
                                                    class="h-5 w-14 rounded-full bg-meta-9 shadow-inner dark:bg-[#5A616B]"></div>
                                                <div
                                                    :class="switcherToggle && '!right-0 !translate-x-full !bg-primary dark:!bg-white'"
                                                    class="dot absolute -top-1 left-0 h-7 w-7 rounded-full bg-white shadow-switch-1 transition"></div>
                                            </div>
                                        </label>
                                    </div>
                                ...
                                <div class="flex flex-col gap-5.5 p-6.5">
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            class="w-full rounded-lg border-[1.5px] border-primary bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:bg-form-input dark:text-white"></textarea>
                                    </div>
