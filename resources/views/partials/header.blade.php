            ...
            <form action="https://formbold.com/s/unique_form_id" method="POST">
                <div class="relative">
                    ...
                    <input
                        ...
                        class="w-full bg-transparent pl-9 pr-4 border-transparent focus:border-transparent focus:ring-0 xl:w-125" />
                </div>
            </form>
        </div>
                        ...
                        <ul class="flex h-auto flex-col overflow-y-auto">
                            <li>
                                <a
                                    ...
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="{{Vite::asset('resources/images/user/user-02.png')}}" alt="users">
                                    </div>
                            ...
                            <li>
                                <a
                                    ...
                                    href="messages.html">
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="{{Vite::asset('resources/images/user/user-01.png')}}" alt="users">
                                    </div>
                            ...
                            <li>
                                <a
                                    ...
                                    href="messages.html">
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="{{Vite::asset('resources/images/user/user-03.png')}}" alt="users">
                                    </div>
                            ...
                            <li>
                                <a
                                    ...
                                    href="messages.html">
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="{{Vite::asset('resources/images/user/user-04.png')}}" alt="users">
                                    </div>
