<aside
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a href="index.html">
            <img src="{{Vite::asset('resources/images/logo/pos-logo.webp')}}" alt="logo" style="height: 35px; width:
            35px">
        </a>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a
                            ...
                            href="#"
                            @click.prevent="selected = (selected === 'productOrder' ? '':'productOrder')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'productOrder') || (page === 'userAll' || page === 'userCreate' || page === 'stocks') }">
                            <svg
                                class="fill-current"
                                width="18"
                                height="18"
                            ...
                            <svg
                                ...
                                :class="{ 'rotate-180': (selected === 'productOrder') }"
                                width="20"
                                height="20"
                                viewBox="0 0 20 20"
                                fill="none"
                        ...
                        <div
                            ...
                            :class="(selected === 'productOrder') ? 'block' :'hidden'">
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a
                                        class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{route('orders.index')}}"
                                        :class="page === 'userAll' && '!text-white'">Product Order
                                    </a>
                                </li>
                                <li>
                                    <a
                                        class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{route('authentication.create')}}"
                                        :class="page === 'userCreate' && '!text-white'">user create
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li>
                        <a
                            ...
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'user') || (page === 'userAll' || page === 'userCreate' || page === 'stocks') }">
                            <svg
                                class="fill-current"
                                width="18"
                                height="18"
                        ...
                        <div
                            ...
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a
                                        class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{route('authentication.index')}}"
                                        :class="page === 'userAll' && '!text-white'">all user
                                    </a>
                                </li>
                                <li>
                                    <a
                    ...
                    <li>
                        <a
                            ...
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'product') || (page === 'formElements' || page === 'formLayout') }">
                            <svg
                                class="fill-current"
                                width="18"
                                height="18"
                            ...
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a
                                        ...
                                        :class="page === 'formElements' && '!text-white'">All Product</a>
                                </li>
                                <li>
                                    <a
                                        class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{route('products.create')}}"
                                        :class="page === 'formLayout' && '!text-white'">Add Product</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
                    ...
                    <li>
                        <a
                            class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="#"
                            @click.prevent="selected = (selected === 'order' ? '':'order')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'order') || (page === 'all-order' || page === 'add-order') }">
                            ...
                            <svg
                                class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                                :class="{ 'rotate-180': (selected === 'order') }"
                                width="20"
                                height="20"
                                viewBox="0 0 20 20"
                                fill="none"
                        ...
                        <div
                            class="translate transform overflow-hidden"
                            :class="(selected === 'order') ? 'block' :'hidden'">
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a
                                        class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{route('orders.index')}}"
                                        :class="page === 'all-order' && '!text-white'">All Order</a>
                                </li>
                                <li>
                                    <a
                                        class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{route('orders.create')}}"
                                        :class="page === 'add-order' && '!text-white'">Add order</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a
                            ...
                            <!-- যদি selected এর মান 'AuthPages' হয় অথবা page এর মান 'register' বা 'login' হয়, তাহলে 'bg-graydark dark:bg-meta-4' ক্লাস যুক্ত হবে। -->
                            <svg
                                class="fill-current"
                                width="18"
                                height="19"
