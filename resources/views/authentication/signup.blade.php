                                ...
                                <div class="px-26 py-17.5 text-center">
                                    <a class="mb-5.5 inline-block" href="index.html">
                                        <img
                                            ...
                                            src="{{Vite::asset('resources/images/logo/logo.svg')}}"
                                            alt="Logo" />
                                        <img
                                            class="dark:hidden"
                                            src="./images/logo/logo-dark.svg"
                                            src="{{Vite::asset('resources/images/logo/logo-dark.svg')}}"
                                            alt="Logo" />
                                    </a>
                                    ...
                                    <span class="mt-15 inline-block">
                                        <img
                                            src="{{Vite::asset('resources/images/illustration/illustration-03.svg')}}"
                                            alt="illustration" />
                                    </span>
                                </div>
                            </div>
                                    ...
                                    <form>
                                        ...
                                        <div class="mt-6 text-center">
                                            <p class="font-medium">
                                                ...
                                                <a href="{{route('authentication.signIn')}}" class="text-primary">Sign in</a>
                                            </p>
                                        </div>
                                    </form>
                                </div>
